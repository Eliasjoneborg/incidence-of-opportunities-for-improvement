...
Trauma, defined as physical injury and the body’s associated response[@Gerdin2015], is the leading cause of death in patients aged 45 or younger[@GlobalStats]. For every trauma death, three persons are rendered permanently disabled[@Trauma], which significantly amplifies the social and economic impacts of the disease as well as the importance of quality trauma care. The two major mechanisms of injury are blunt trauma, mainly due to falls, traffic accidents and assaults, and penetrating trauma, mainly due to stabbing or use of firearms[@Trauma].<!-- You can remove the last sentence, because it can be considered general knowledge -->

To achieve quality trauma care trauma systems in many countries typically involves: (i) centralising trauma care to specialised trauma centres, (ii) benchmarking of outcomes through trauma registries and (iii) continuous retrospective assessment of care provided through multidisciplinary mortality and morbidity review board conferences. Following the widespread introduction of trauma systems, the prevalence of extensive institutional, regional and national trauma registries and review board records have increased greatly, as have the number of investigatory studies that constitute trauma epidemiology. <!-- Consider removing this last sentence. In my opinion a trauma system is like a health system, it exists everywhere where there are trauma patients, but may be structured very differently and be of varying quality--> 

Historically within trauma epidemiology, much emphasis has been placed on benchmarking rates of mortality and morbidity and rates of death preventability [ref]. Continuous benchmarks of mortality and morbidity rates are essential to a well functioning quality improvement process. Rates of death preventability, however, constitutes a poor measure of care quality due to intrinsic problems in its review process, along with its poor external validity [ref:s]. A sound measure of care quality is nonetheless needed, as it allows for comparisons of care to be made, not only across institutions, but within institutions across the spectrum of disease.<!-- Consider removing this paragraph, and just jump straight to OFI--> 

In recent years, the term 'opportunities for improvement' in care provided (OFI) have emerged in the trauma literature, representing a dichotomous proxy measure for care quality. OFI is defined as patient care disharmonious with the current best practice guidelines, and relies on a consensus decision by an expert review board. Rates of OFI constitutes a more accurate measure of care quality than rates of death preventability<!-- Not sure about this sentence, starting with "Rates of OFI..", consider removing-->. Unequal distributions of OFI within different parts of the trauma population can help spotlight negative trends that may be rectified through corrective intervention. Hitherto, no study has set out to estimate rates of OFI within the general Scandinavian trauma population<!-- Have you seen papers from other settings on the rates of OFI? I think it makes sense to cite some studies on OFI here, to clarify the knowledge gap. The new setting and population is definitely part of that, but perhaps also that no other studies have looked at how OFI changes over time and how they are distributed between different cohorts?-->.

## Aim
The aim of this study is to measure the incidence of OFI in care provided across different cohorts at KUH trauma centre, identify problem areas and estimate temporal incidence trends.<!-- Remove the separate aim heading and add to the end of background. Also, make sure you clarify the knowledge gap before you introduce the aim, so focus on the distribution of OFI across cohorts and the temporal trends. I would also replace KUH with "major Scandinavian trauma centre" or something like that -->

# Methods

## Study design
We analysed data <!-- In your paper, as compared to the thesis, use first person active voice, as it's so much easier to read. So instead of "a cohort study was conducted", write "We conducted a cohort study". Now, I think you can leave the cohort thing out of there entirely, and just write that we analysed data from the two registries -->from the Swedish Trauma Registry (SweTrau) and the Karolinska University Hospital Trauma Care Quality Database (KUH TCQD). We grouped patients according to the cohort definitions<!-- What cohort definitions? Please add here--> in a complete case analysis. Semiannual and cumulative incidence of OFI was measured within cohorts and specific problem areas were identified. A trend analysis was then conducted by fitting the incidence data into a linear model with a time series component.

## Setting
The KUH trauma centre in Stockholm, Sweden is an American College of Surgeons trauma level-1 centre, which manages 1300 trauma patients each year. Trauma patients are triaged in a pre-hospital setting as a priority one or two by assessing vital physiological parameters, anatomical criteria, and mechanism of injury. The pre-hospital system includes a helicopter emergency medical service and three physician staffed ambulances. The in-hospital system includes a multidisciplinary trauma team comprised of a surgeon, an anesthesiologist, an orthopedic surgeon, a radiologist, a surgical nurse, an assistant surgical nurse, a nurse anesthetist, an emergency medicine nurse, an emergency medicine assistant nurse and a radiology nurse. Consultations with associated specialties are available around the clock. The team has immediate access to radiology, surgery, and intensive care.

All patients admitted to KUH with trauma team activation, as well as patients admitted without trauma team activation, but retrospectively found to have a new injury severity score (NISS) of greater than 15 are included in both SweTrau and KUH TCQD. Patients who trigger trauma team activation despite not having suffered trauma and patients whose only injury is chronic subdural hematoma are not included. KUH organizes monthly multidisciplinary trauma mortality and morbidity review board conferences, selecting patients from SweTrau and KUH TCQD using audit filters and extensive nursing review (see figure \@ref(fig:swetrau-flowchart)). 

The audit filters used at KUH are: systolic blood pressure less than 90; Glasgow coma scale (GCS) less than 9 and not intubated; injury severity score (ISS) greater than 15 and not admitted to the intensive care unit; time to acute intervention greater than 60 minutes; time to computed tomography greater than 30 minutes; and death within 30 days following trauma. The review board is comprised of representatives from all disciplines commonly involved in trauma care - surgery, vascular surgery, neurosurgery, orthopedics, anesthesia and intensive care, nursing, and radiology. Their purpose is to reach a consensus regarding the presence of OFI and implement appropriate corrective actions. The nature of that which can be improved is then registered in KUH TCQD.
...
### Study population
We included all adult trauma patients (defined as 15 years or older) in the KUH TCQD, with complete OFI data and a hospital admission date between 2017 and 2022. We selected 2017 because the review process and associated data collection was formalised that year.

### Cohorts
<!-- I'm thinking that this information would fit better under Design --> 
Grouping<!-- Replace with "We grouped..."--> was conducted pertaining to directives from the American College of Surgeons Trauma Quality Improvement Program, using the Abbreviated Injury Scale (AIS) grading system, which forms a number of seven digits indicating (i) region of injury, (ii) type of anatomical structure, (iii) specific anatomical structure, (iv) level of injury and (v) severity of injury[@TQIP; @AIS]. Patients were grouped by principal mechanism of injury (blunt, penetrating), post-injury condition (shock, severe traumatic brain injury) and age. Certain ACS TQIP cohorts are excluded as a result of local directives<!-- I don't understand this part about local directives. Can you clarify?-->, limitations to the data contained in SweTrau and the time and resources dedicated to this study. Presented below are inclusion and exclusion criteria by cohort.

**Cohort inclusion and exclusion criteria**
<!-- I would prefer calling these "Cohort definitions" or something similar. Also note that you'll need to number this table, so it may be easier to wrap it in a R chunk -->
...
## Variables
<!-- This section should include information on what variables that were considered, so that would be all the variables in Table 2. -->

### Outcome variable
<!-- I would avoid using both opportunities for improvement and problem area, as they are basically the same thing. So I would write that you analysed opportunities for improvement as both a categorical and dichotomous variable. You used the dichotomous version when analysing incidence and trend, and the categorical version to identify specific OFI -->
...
## Statistical methods
We used R for data management and statistical analyses<!-- Add R citation-->. We extracted data from SweTrau and KUH TCQD, and matched observations between these databases using patient id and date of arrival to the trauma centre. We assigned patients to the different trauma cohorts using the definitions listed above and calculated the semiannual and cumulative incidence of OFI for each cohort and for the study sample in its entirety. A linear regression model with a time series component was then applied to the incidence data to estimate temporal incidence trends. Statistical significance was defined as P<0,05 with a 95% confidence interval.

### Bias
The data analysis plan and statistical code were developed on a step-by-step basis using simulated data. It was rigorously tested throughout its development process, before it was applied to the real data. Selection bias, caused by the inclusion criteria for the KUH TCQD and SweTrau, is possible.<!-- I'm not sure about this selection bias. If the aim is to estimate incidence in different cohorts at KUH, how would selection bias come into play?-->
...
# Results
## Participants 
Over the study period, `r nrow(datasets$problem)` patients were included in the the KUH TCQD. 5951 patients were excluded as the selection process and the constitution of the review board were different prior to 2017<!-- If you study period was 2017-2022, then patients included in the databases before 2017 cannot be excluded, as they were never included. So stating the number of patients included between 2017 and 2022 is enough-->  . `r nrow(fewer_variables)` (`r round(nrow(fewer_variables)/nrow(datasets$problem)*100, digits=1)`%) patients were aged 15 or greater and had sufficient data regarding OFI (see figure \@ref(fig:exclusion-flowchart)). The blunt multisystem cohort included `r nrow(blunt_multisystem_cohort)` patients; penetrating included `r nrow(penetrating_cohort)` patients; severe TBI included `r nrow(severe_tbi_cohort)` patients; shock included `r  nrow(shock_cohort)` patients and geriatric included `r nrow(geriatric_cohort)` patients. Five categories of data were necessary for grouping: age, emergency department gcs, emergency department systolic blood pressure, AIS score and dominant injury type (blunt or penetrating)<!-- This information, about the variables required, should be moved to Variables above-->. 932 patients lacked data about age, `r Exclusion_table$Missing[3]` patients lacked data about emergency department GCS and `r Exclusion_table$Missing[4]` patients lacked data about emergency department blood pressure. No patients lacked data about dominant injury type or AIS score.
...
# Discussion
<!-- The discussion is overall a bit wordy and would benefit from more direct language. Some more citations of other studies of OFI would also help, for example:
https://academic.oup.com/bjs/article/100/6/749/6138406
https://sjtrem.biomedcentral.com/articles/10.1186/s13049-017-0353-5
-->

# Key results
The aim of this study was to measure the semiannual and cumulative incidence of OFI in the trauma cohorts blunt multisystem, penetrating, severe TBI, shock and geriatric at KUH trauma centre to obtain rough estimates of care quality throughout the trauma population, independent of mortality or morbidity rates<!-- Make sure that the aim here is exactly the same as in the abstract and end of introduction. I'm not sure dividing the aim into principal and secondary helps, as it's quite short already, so just spell out the full aim and then address each part separately -->. There was sizable variance in cumulative incidence of OFI across the trauma cohorts. The cumulative incidence of OFI in the blunt multisystem cohort (17,7%), stands in stark contrast to that of the penetrating cohort (6%) or the general trauma population (5,8%). There were large shifts in amplitude in semiannual incidence of OFI. The secondary aims were to identify problem areas and estimate temporal incidence trends. The four most common problem areas in the overall cohort pertained to resource management, emergency department triage, time to surgery and injury identification. The general trauma population and all five cohorts had negative temporal incidence trend estimates, suggesting of an overall downtrend. No trend were statistically significant.

# Interpretation
The considerable differences in cumulative incidence of OFI between cohorts suggest that the quality of care differ across the trauma spectrum of disease. The relative risk of experiencing OFI is 3.05 for the blunt multisystem cohort compared to the general trauma population and 2.95 compared to the penetrating cohort<!-- One typically want to avoid introducing "new" results in the discission, so consider using the same figures as in the Results-->. Intuitively, one might ascribe the differences in cumulative incidence of OFI to the difference in difficulty pertaining to diagnosing and management. In treating blunt multisystem trauma: deciphering patient presentation may be harder; the probability of missing injuries greater; and overall management generally more complex than penetrating trauma.

OFI is however defined as care disharmonious with best practice guidelines<!-- Is this an "offical" definition? Do you have a source? If so, please add.-->, assuming that it is possible to follow said guidelines in every case. Granting that physicians sometimes must resort to professional judgement and that a significant portion of OFI recorded is attributable to hospital level factors, straying from guidelines in as much as 17,7 percent of patient cases suggests that KUH has some way to go in terms of quality improvement for patient with blunt trauma. Few results are unambiguous and these are no exception: in cumulative incidence of OFI, there is no single outlier, but rather a continuum and and potential future initiatives should reflect that and be taken proportionally. Quality improvement should also strike a balance between targeting trauma cohorts with a high cumulative incidence of OFI and trauma cohorts where care disharmonious to best practice guidelines pose the greatest risk for serious disability or death.
