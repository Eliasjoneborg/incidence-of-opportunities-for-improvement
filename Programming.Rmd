...
## Överväg att köra "with" med ifelse, där du precicerar vilka som är "Yes" och reserande blir dåliga: exv
## problem_scrambled$probYN <- with(problem_scrambled, ifelse(
...
## Detta är alltså kriterier för swetrau? Eg ska vi inte behöva filtrera detta då det redan ska vara gjort. Vi får disk nästa möte.
