...
graph [layout = dot, size=30, ranksep = 2, nodesep = 1]
...
## Swedish
*Bakgrund:* Trauma är den ledande orsaken till död och permanent fysiskt handikapp hos patienter yngre än 45 år, liksom den enskilt största bidragande faktorn till förlust av arbetsföra år. Begreppet 'förbättringsmöjligheter' används inom traumalitteraturen som ett grovt mått av vårdkvalitet. Hittills har inga studier analyserat incidensen av förbättringsmöjligheter inom den skandinaviska traumapopulationen.
*Syfte:* Att beräkna incidensen av förbättringsmöjligheter i olika traumakohorter vårdade på Karolinska Universitetssjukhuset (KS) och att förutspå incidenstrender.
*Metod:* En retrospektiv observationell kohortstudie med data från det svenska traumaregistret (SweTrau) och KS traumavårdkvalitetsdatabas (TVKD) har genomförts. Patienter har grupperats efter huvudsaklig skademekanism (trubbigt eller penetrerande våld), efterföljande sjukdomstillstånd (shock, svår traumatisk hjärnskada) och ålder.
*Resultat:* Efter genomförd exklusion återstod 5214 patienter som vårdats på KS mellan 2017 och 2021. Patienter med trubbigt multitrauma (n=463) hade den högsta kumulativa incidensen av förbättringsmöjligheter (17,7%). Patienter med penetrerande trauma (n=183) hade den lägsta kumulativa incidensen av förbättringsmöjligheter (6%). Samtliga kohorter hade nedåtgående trender av förbättringsmöjlighet vid analys i en linjär modell som hanterar tiddsseriedata. De fyra vanligaste problemområdena var: bristande resurshantering, feltriagering på akutmottagningen, för lång väntan på operation och missade skador. Inga trender uppnådde kriterierna för statistisk signifikans.
*Slutsats:* Incidensen av förbättringsmöjligheter var oproportioneligt distribuerad mellan traumakohorterna. Den högsta incidensen av förbättringsmöjligheter återfanns i kohorten trubbigt multitrauma. Framtida initiativ bör syfta till att åtgärda förbättringsområden i vården av patienter med  trubbigt multitrauma.

## English
*Background:* Trauma is the leading cause of death and permanent disability in patients below the age of 45, and is a major contributor to loss of work years. Opportunities for improvement (OFI) in injury management is emerging in the trauma literature as a coarse proxy measure for care quality. Hitherto, no studies have analyzed OFI incidence within the Scandinavian trauma population. 
*Aim:* To measure OFI incidence within the KUH trauma cohorts, identify problem areas and predict incidence trends. 
*Methods:* A retrospective cohort study was conducted, using data from the Swedish trauma registry (SweTrau) and Karolinska University Hospital’s (KUH) Trauma Care Quality Database (TCQD). Patients were grouped into cohorts by principal mechanism of injury (blunt, penetrating), post-injury condition (shock, severe traumatic brain injury) and age. 
*Results:* After exclusions, 5214 trauma patients treated at KUH between 2017 and 2021 remained. The blunt multisystem cohort (n = 463) had the highest cumulative OFI incidence (17,7%) and the penetrating cohort had (n =183) the lowest (6,0%). The four most common problem areas were: improper resource management, emergency department mistriage, prolonged wait for necessary surgical intervention and a failure to identify injuries. All cohorts had negative temporal incidence trends. No trends were statistically significant (p>0,05, 95% CI). 
*Conclusion:* OFI incidence was disproportionately distributed among the KUH trauma cohorts. The blunt multisystem cohort had the highest OFI incidence. Areas of improvement in management of patients with severe blunt multisystem injuries should be addressed.
