...
## Swedish
*Bakgrund:* Trauma är den ledande orsaken till död och permanent fysiskt handikapp hos patienter yngre än 45 år, liksom den enskilt största bidragande faktorn till förlust av arbetsföra år. Begreppet 'förbättringsmöjligheter' använts inom traumalitteraturen som ett grovt mått för vårdkvalitet. Hittills har inga studier analyserat incidensen av förbättringsmöjligheter inom den skandinaviska traumapopulationen.
*Syfte:* Att beräkna incidens av förbättringsmöjligheter i olika traumakohorter vårdade på Karolinska Universitetssjukhuset (KS), att identifiera problemområden och att förutspå incidenstrender.
*Metod:* En retrospektiv kohortstudie med data från det svenska traumaregistret (SweTrau) och KS traumavårdkvalitetsdatabas (TVKD) har genomförts med syftet att beräkna incidens av förbättringsmöjligheter inom traumapopulationen. Patienter har grupperats efter huvudsaklig skademekanism (trubbigt eller vasst våld), efterföljande sjukdomstillstånd (shock, svår traumatisk hjärnskada) och ålder.
*Resultat:* Efter genomförd exklusion återstod 5214 patienter som vårdats på KS mellan 2017 och 2021. Patienter som erfarat trubbigt multitrauma (n=463) hade den högsta kumulativa incidensen av förbättringsmöjligheter (17,7%). Patienter som erfarat vasst trauma (n=183) hade den lägsta kumulativa incidensen av förbättringsmöjligheter (6%). Samtliga kohorter hade nedåtgående trender av förbättringsmöjlighet vid analys i en linjär modell som hanterar tiddsseriedata. De fyra vanligaste problemområdena var: bristande resurshantering, feltriagering på akutmottagningen, för lång väntan på operation och missade skador. Inga trender uppnådde kriterierna för statistisk signifikans.
*Slutsats:* Incidensen av förbättringsmöjligheter var oproportioneligt distribuerad mellan traumakohorterna. Den högsta incidensen av förbättringsmöjligheter återfanns i kohorten trubbigt multitrauma. Framtida initiativ bör syfta till att åtgärda förbättringsområden i vården av patienter som erfarat trubbigt multitrauma.
